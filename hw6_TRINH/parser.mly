...
expr:
    ...
    | UNPAIR; LPAREN; id1 = ID; COMMA; id2 = ID; RPAREN; EQUALS; e_pair = expr; IN; e_body
      = expr { Unpair(id1, id2, e_pair, e_body) }
    | EMPTYLIST; e1 = texpr { EmptyList(e1) }
    | CONS; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Cons(e1, e2) }
    | HD; LPAREN; e1 = expr; RPAREN { Hd(e1) }
    | TL; LPAREN; e1 = expr; RPAREN { Tl(e1) }
    | NULL_QUESTION; LPAREN; e1 = expr; RPAREN { Null(e1) }
    | EMPTYTREE; e1 = texpr { EmptyTree(e1) }
    | NODE; LPAREN; e1 = expr; COMMA; e2 = expr; COMMA; e3 = expr RPAREN { Node(e1, e2, e3) }
    | NULLT_QUESTION; LPAREN; e1 = expr; RPAREN { NullT(e1) }
    | GETDATA; LPAREN; e1 = expr; RPAREN { GetData(e1) }
    | GETLST; LPAREN;  e1 = expr; RPAREN { GetLST(e1) }
